...
<!-- Mirrored from htmlbeans.com/html/petshop/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Nov 2019 01:59:52 GMT -->
<head>
	...
	<link rel="stylesheet" type="text/css" href="template_front/css/font-awesome.css">
	<link rel="stylesheet" type="text/css" href="template_front/css/bootstrap.css">
	<link rel="stylesheet" type="text/css" href="template_front/css/icon-fonts.css">
	<link rel="stylesheet" type="text/css" href="template_front/css/plugins.css">
	<link rel="stylesheet" type="text/css" href="template_front/style.css">
</head>
<body>
	<div id="wrapper">
		<header id="header">
					...
					<div class="col-xs-12 col-sm-6 hidden-xs">
						<div class="social-list">
							...
							<ul class="list-unstyled account-cart">
								<li><a href="login.html"><i class="icon-user"></i><span class="hidden-xs">Account</span></a></li>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="logo pull-left hidden visible-xs">
							<a href="index-2.html"><img class="img-responsive" src="template_front/images/logo.png" alt="PetShop"></a>
						</div>
						...
						<nav id="nav">
							<ul class="list-unstyled text-uppercase menu-left">
								...
								<li class="logo hidden-xs"><a href="index-2.html"><img class="img-responsive" src="template_front/images/logo.png" alt="PetShop"></a></li>
								<li class="mar-zero">
									<a href="javascript:void(0);">bon Plans</a>
									<ul class="list-unstyled text-uppercase dropdown">
										<li><a href="?core=promotion&action=page_promo_client">promotions</a></li>
										<li><a href="single-blog.html">Carte de fidélité</a></li>
									</ul>
								</li>
			...
			<section class="abt-sec container">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-5">
						<div class="img-holder"><img src="template_front/images/img02.jpg" alt="pet-image" class="img-responsive"></div>
					</div>
				</div>
			</section>
			<section class="services-sec bg-full" style="background-image:url(images/img03.jpg);">
				<div class="container">
					<div class="row">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-6">
							<div class="services-holder">
								<div class="img-holder"><img src="template_front/images/img04.jpg" alt="Pet Adoption" class="img-responsive"></div>
						...
						<div class="col-xs-12 col-sm-6">
							<div class="services-holder">
								<div class="img-holder"><img src="template_front/images/img05.jpg" alt="Pet Grooming" class="img-responsive"></div>
								<div class="txt-holder">
						...
						<div class="col-xs-12 col-sm-6">
							<div class="services-holder">
								<div class="img-holder"><img src="template_front/images/img06.jpg" alt="Pet Daycare" class="img-responsive"></div>
								<div class="txt-holder">
						...
						<div class="col-xs-12 col-sm-6">
							<div class="services-holder">
								<div class="img-holder"><img src="template_front/images/img07.jpg" alt="Dog Training" class="img-responsive"></div>
								<div class="txt-holder">
						...
						<div class="product-block">
							<div class="product-col">
								<div class="img-holder">
									<img src="template_front/images/img08.jpg" alt="food-img" class="img-responsive">
							...
							<div class="product-col">
								<div class="img-holder">
									<img src="template_front/images/img09.jpg" alt="food-img" class="img-responsive">
									<div class="over-holder">
										<ul class="list-unstyled text-center share-list">
											<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
											<li><a href="#"><i class="icon-refresh"></i></a></li>
							...
							<div class="product-col">
								<div class="img-holder">
									<img src="template_front/images/img10.jpg" alt="food-img" class="img-responsive">
									<span class="sale-item">Sale!</span>
									<div class="over-holder">
										<ul class="list-unstyled text-center share-list">
											<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
							...
							<div class="product-col sold-item">
								<div class="img-holder">
									<img src="template_front/images/img11.jpg" alt="food-img" class="img-responsive">
									<div class="over-holder">
										<ul class="list-unstyled text-center share-list">
											<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
											<li><a href="#"><i class="icon-refresh"></i></a></li>
							...
							<div class="product-col">
								<div class="img-holder">
									<img src="template_front/images/img12.jpg" alt="food-img" class="img-responsive">
									<div class="over-holder">
										<ul class="list-unstyled text-center share-list">
											<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
											<li><a href="#"><i class="icon-refresh"></i></a></li>
							...
							<div class="product-col">
								<div class="img-holder">
									<img src="template_front/images/img13.jpg" alt="food-img" class="img-responsive">
									<div class="over-holder">
										<ul class="list-unstyled text-center share-list">
											<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
											<li><a href="#"><i class="icon-refresh"></i></a></li>
							...
							<div class="product-col">
								<div class="img-holder">
									<img src="template_front/images/img14.jpg" alt="food-img" class="img-responsive">
									<div class="over-holder">
										<ul class="list-unstyled text-center share-list">
											<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
											<li><a href="#"><i class="icon-refresh"></i></a></li>
							...
							<div class="product-col">
								<div class="img-holder">
									<img src="template_front/images/img15.jpg" alt="food-img" class="img-responsive">
									<div class="over-holder">
										<ul class="list-unstyled text-center share-list">
											<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
											<li><a href="#"><i class="icon-refresh"></i></a></li>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="image-holder overlay">
							<img src="template_front/images/img17.jpg" alt="image description" class="img-responsive">
							<a href="#" class="icon lg-round text-center"><i class="fa fa-search" aria-hidden="true"></i></a>
						</div>
						<div class="image-holder overlay">
							<img src="template_front/images/img18.jpg" alt="image" class="img-responsive">
							<a href="#" class="icon lg-round text-center"><i class="fa fa-search" aria-hidden="true"></i></a>
						</div>
						<div class="image-holder overlay">
							<img src="template_front/images/img19.jpg" alt="image" class="img-responsive">
							<a href="#" class="icon lg-round text-center"><i class="fa fa-search" aria-hidden="true"></i></a>
						</div>
						<div class="image-holder overlay">
							<img src="template_front/images/img20.jpg" alt="image" class="img-responsive">
							<a href="#" class="icon lg-round text-center"><i class="fa fa-search" aria-hidden="true"></i></a>
						</div>
						<div class="image-holder overlay col-holder">
							<img src="template_front/images/img21.jpg" alt="image" class="img-responsive">
							<a href="#" class="icon lg-round text-center"><i class="fa fa-search" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
			...
			<section class="blog-sec container">
				...
				<div class="row">
					<div class="col-sx-12 col-sm-4">
						<div class="blog-col text-center">
							<div class="img-holder overlay">
								<img src="template_front/images/img23.jpg" alt="image" class="img-responsive">
					...
					<div class="col-sx-12 col-sm-4">
						<div class="blog-col text-center">
							<div class="img-holder overlay">
								<img src="template_front/images/img25.jpg" alt="image" class="img-responsive">
								<a href="#" class="icon round"><i class="fa fa-search" aria-hidden="true"></i></a>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-4 abt-txt">
						<div class="footer-logo">
							<a href="#"><img src="template_front/images/footer-logo.png" alt="Pet Shop" class="img-responsive"></a>
						</div>
						<p>It is a long established fact that a reader <br class="hidden-xs">distracted by the readable content</p>
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						...
						<ul class="insta-list list-unstyled">
							<li><a href="#"><img src="template_front/images/img27.jpg" alt="footer-img" class="img-responsive"></a></li>
							<li><a href="#"><img src="template_front/images/img28.jpg" alt="footer-img" class="img-responsive"></a></li>
							<li><a href="#"><img src="template_front/images/img29.jpg" alt="footer-img" class="img-responsive"></a></li>
							<li><a href="#"><img src="template_front/images/img30.jpg" alt="footer-img" class="img-responsive"></a></li>
							<li><a href="#"><img src="template_front/images/img31.jpg" alt="footer-img" class="img-responsive"></a></li>
							<li><a href="#"><img src="template_front/images/img32.jpg" alt="footer-img" class="img-responsive"></a></li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-3">
						<h3>Newsletter</h3>
	...
	<script src="template_front/js/jquery.js"></script>
	<script src="template_front/js/plugins.js"></script>
	<script src="template_front/js/jquery.main.js"></script>
</body>
