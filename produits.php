              ...
              <div class="product-block">
                ...
                <?php
                  ...
                  foreach ($listproduit as $value) {
                    ...
                    foreach ($liste as $val) {
                      if ($val['idProduit']==$value['idProduit']){
                        $hasPromo=true;
                ...
                <div class="product-col">
                  <div class="img-holder">
                    ...
                    <?php if ($hasPromo) {
                      ?>
                        <span class="sale-item"><?php echo $pourcentage ?>%</span>
                      <?php
                    } ?>
                  ...
                  <div class="descrip">
                    <h3 class="heading2"><?php echo $value['libProduit'] ?></h3> 
                    <span class="price"><?php echo $value['prixProduit'] ?> DT 
                      <?php if ($hasPromo) {
                      ?>
                        / 
                      <?php
                        echo $value['prixProduit']-($value['prixProduit']*$pourcentage/100);
                     ?>
                        DT 
                      <?php } ?>
                    </span>    
                  ...
                  <div class="text-center">
                    <a href="?core=produit&action=afficher_produit&id=<?php echo $value['idProduit'] ?>" class="btn-primary lg-round text-uppercase"><i class="icon-cart"></i>add to cart</a>
                  </div>
                </div>
                <?php
                  }
