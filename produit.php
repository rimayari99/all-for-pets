...
<body>
  <div id="wrapper">
    ...
    <main id="main">
      <section class="hero-sec bg-full" style="background-image:url(template_front/images/img33.jpg);">
        <div class="caption">
            ...
            <article id="content">
              <div class="holder">
                <div class="block">
                  <div class="product-slider">
                    <div class="slide">
                      <img src="template_front/images/img08.jpg" alt="image" class="img-responsive">
                    </div>
                  </div>
                  <ul class="list-unstyled slick-slider pagg-slider">
                          <li><img src="template_front/images/img08.jpg" alt="image description"></li>
                      </ul>
                  </div>
                  <?php
                  $liste;
                  foreach ($listpromo as $value) {
                    ...
                    foreach ($liste as $val) {
                      if ($val['idProduit']==$prod['idProduit']){
                        $hasPromo=true;
                ...
                <div class="text-holder">
                  <h3><?php echo $prod['libProduit'] ?></h3> 
                  <span class="price"><?php echo $prod['prixProduit']; ?> DT 
                    <?php if ($hasPromo) {
                      ?>
                        / 
                      <?php
                        echo $prod['prixProduit']-($prod['prixProduit']*$pourcentage/100);
                     ?>
                        DT 
                      <?php } ?>
                  </span>  
                  <p><?php echo $prod['descProduit'] ?></p>  
              ...
              <div class="related-products">
                ...
                <div class="product-box">
                  ...
                  <div class="product-col">
                    <div class="img-holder">
                      <img src="template_front/images/img39.jpg" alt="food-img" class="img-responsive">
                      <div class="over-holder">
                        <ul class="list-unstyled text-center share-list">
                          <li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
                          <li><a href="#"><i class="icon-refresh"></i></a></li>
            ...
            <aside id="sidebar">
              ...
              <section class="widget">
                ...
                <ul class="list-unstyled feature-list">
                  <li>
                    <div class="img-holder">
                      <a href="shop-detail.html"><img class="img-responsive" src="template_front/images/img40.jpg" alt="image"></a>
                    </div>
                  ...
                  <li>
                    <div class="img-holder">
                      <a href="shop-detail.html"><img class="img-responsive" src="template_front/images/img41.jpg" alt="image"></a>
                    </div>
                    <div class="txt-holder">
                      <ul class="list-unstyled rating-list">
                        <li><a href="#" class="fa fa-star-o"></a></li>
                  ...
                  <li>
                    <div class="img-holder">
                      <a href="shop-detail.html"><img class="img-responsive" src="template_front/images/img42.jpg" alt="image"></a>
                    </div>
                    <div class="txt-holder">
                      <ul class="list-unstyled rating-list">
                        <li><a href="#" class="fa fa-star-o"></a></li>
      ...
      <section class="callout" style="background-image:url(template_front/images/img26.jpg);">
        <div class="container">
          <div class="row">
